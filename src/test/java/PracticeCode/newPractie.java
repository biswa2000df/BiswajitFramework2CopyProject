...
public class newPractie {
	...
	public static void main(String args[]) throws FilloException, IOException {
		...
		/*
		 * htmlReport = new ExtentHtmlReporter("normal.html"); extent = new
		 * ExtentReports(); extent.attachReporter(htmlReport);
		 * 
		 * htmlReport.config().setDocumentTitle("Biswajit FrameWork Report");// Title of
		 * the report htmlReport.config().setReportName("Automation Report");// Name of
		 * the report
		 ...
		 * extent.setSystemInfo("OS", "Window11"); extent.setSystemInfo("Tester Name",
		 * "Biswajit"); extent.setSystemInfo("Browser", "Chrome");
		 * extent.setSystemInfo("Application URL", "https://www.google.com");
		 */
		File f = new File("kanha.csv");
		creaateCsvFile("Test_Case", "Description", "ExpectedResult", "ActualResult", "Status", "Date", "Time",
				"Screenshot_File_Location", "BrowserType", "IP", "HOST", "ZONE", f);

		Fillo fillo = new Fillo();
		Connection conn = fillo.getConnection(
				System.getProperty("user.dir") + File.separator + "DataSheet" + File.separator + "IshinePortal.xlsx");
...
//				extentrepost();
				creaateCsvFile1(Test_Case, Description, "ExpectedResult", "ActualResult", "Status", "Date", "Time",
						"Screenshot_File_Location", "BrowserType", "IP", "HOST", "ZONE", f);
			}
...
//		flush1();
	 ...
	 * i++;
	 * 
	 * // test = extent.createTest( // "<font color=\"Blue\"><b>" + Scenario_ID +
	 * "</b></font> - <font color=\"Brown\"><b>" + Module // +
	 * "</b></font> - <font color=\"Green\"><b>" + Test_Case + "</b></font> ( " +
	 * Description + " )", // "</br><h4><font color=\"Lime\"><b>" +
	 * Module.toUpperCase() + "</b></font></h4>") // .createNode("My_Child_Test - "+
	 * i ).assignCategory("BISWAJIT");
	 * 
	 ...
	 * }
	 * 
	 * public static void flush1() { extent.flush(); }
	 */
	static FileWriter writer;
	public static void creaateCsvFile(String Test_Case, String Description, String ExpectedResult, String ActualResult,
			String Status, String Date, String Time, String Screenshot_File_Location, String BrowserType, String IP,
			String HOST, String ZONE, File f) throws IOException {
		writer = new FileWriter(f, true);

		CSVWriter csvwriter = new CSVWriter(writer);
		String s[] = { "<font color=\"Blue\"><b>Module - </b></font>" , Description, ExpectedResult, ActualResult, Status, Date, Time,
				Screenshot_File_Location, BrowserType, IP, HOST, ZONE };
		csvwriter.writeNext(s);
		csvwriter.close();

	}
	public static void creaateCsvFile1(String Test_Case, String Description, String ExpectedResult, String ActualResult,
			String Status, String Date, String Time, String Screenshot_File_Location, String BrowserType, String IP,
			String HOST, String ZONE, File f) throws IOException {
		writer = new FileWriter(f, true);

		CSVWriter csvwriter = new CSVWriter(writer);
		String s[] = { "=HYPERLINK(\"" + Test_Case + "\")", Description, ExpectedResult, ActualResult, Status, Date, Time,
				Screenshot_File_Location, BrowserType, IP, HOST, ZONE };
		csvwriter.writeNext(s);
		csvwriter.close();
